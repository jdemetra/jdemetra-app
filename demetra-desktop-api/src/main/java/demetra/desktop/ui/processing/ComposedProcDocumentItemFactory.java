 ...
 */
public abstract class ComposedProcDocumentItemFactory<D extends ProcDocument, I> implements IProcDocumentItemFactory {
 ...
 non-null and are checked to find out NPE as early as possible.
     ...
     * @param itemUI
     */
    public ComposedProcDocumentItemFactory(@NonNull Class<D> documentType, @NonNull Id itemId, @NonNull Function<? super D, I> extractor, @NonNull ItemUI<? extends IProcDocumentView<D>, ?> itemUI) {
    ...
    @Override
    public JComponent getView(IProcDocumentView<? extends ProcDocument> host, ProcDocument document) {
        ...
        Object info = extractor.apply(source);
        if (info == null) {
    ...
    private final class JAsyncView extends JComponent {
        ...
        public JAsyncView(final IProcDocumentView<? extends ProcDocument> host, final D source) {
