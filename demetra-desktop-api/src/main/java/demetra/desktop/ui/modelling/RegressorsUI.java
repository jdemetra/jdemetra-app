 ...
 * @param <V>
 */
public class RegressorsUI<V extends IProcDocumentView<?>> extends DefaultItemUI<V, RegSarimaModel> {

    @Override
    public JComponent getView(V host, RegSarimaModel information) {
