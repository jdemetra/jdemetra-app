...
public class HighFreqOutlierDescriptor implements IPropertyDescriptors {
    ...
    public HighFreqOutlierDescriptor(LocalDate pos, OutlierType type) {
        this.position = pos;
        this.type = type;
        parameter = Parameter.undefined();
        name = null;
    ...
    public HighFreqOutlierDescriptor(LocalDate pos, OutlierType type, Parameter parameter, String name) {
        this.position = pos;
        this.type = type;
    ...
    public <O extends IOutlier> HighFreqOutlierDescriptor(Variable<O> var) {
        O core = var.getCore();
    ...
    public HighFreqOutlierDescriptor(HighFreqOutlierDescriptor desc) {
    ...
    public HighFreqOutlierDescriptor duplicate() {
        return new HighFreqOutlierDescriptor(this);
    }
