 ...
 */
@SwingComponent
public final class JRevisionChartPanel extends JComponent implements TimeSeriesComponent {
     ...
     */
    public JRevisionChartPanel() {
        setLayout(new BorderLayout());
        panel = new JChartPanel(new JFreeChart("", TsCharts.CHART_TITLE_FONT, new XYPlot(), false));
...
//        fillInputMap(getInputMap());
    ...
    protected Transferable transferableOnSelection() {
        ...
        return DataTransferManager.get().fromTsCollection(TsCollection.of(col));
    }
