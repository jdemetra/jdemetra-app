...
@OptionsPanelController.SubRegistration(
        ...
        keywordsCategory = "SA/General"
)
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_General=General", "AdvancedOption_Keywords_General=General"})
public final class GeneralOptionsPanelController extends OptionsPanelController {

    public static final String ID = "SA/General";
