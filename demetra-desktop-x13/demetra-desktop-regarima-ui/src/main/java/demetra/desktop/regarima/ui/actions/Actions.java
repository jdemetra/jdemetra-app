...
public class Actions {
    ...
    @ActionReferences({
        @ActionReference(path = RegArimaSpecManager.ITEMPATH, position = 1050),
        @ActionReference(path = RegArimaDocumentManager.ITEMPATH, position = 1050)
    })
    ...
    @ActionReferences({
        @ActionReference(path = RegArimaSpecManager.ITEMPATH, position = 1150),
        @ActionReference(path = RegArimaDocumentManager.ITEMPATH, position = 1150)
    })
    ...
    @ActionReferences({
        @ActionReference(path = RegArimaSpecManager.ITEMPATH, position = 1100),
