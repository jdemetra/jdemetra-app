 ...
 */
public class Workspace implements IDisposable {
    ...
    public IWorkspaceRepository getRepository() {
    ...
    public <T> WorkspaceItem<T> searchDocument(T element) {
    ...
    public <T> WorkspaceItem<T> searchDocument(Id id, Class<T> tclass) {
        IWorkspaceItemManager<?> manager = WorkspaceFactory.getInstance().getManager(id.parent());
        if (manager == null) {
            return null;
        }
    ...
    private void addDefaultItems() {
        for (IWorkspaceItemManager mgr : WorkspaceFactory.getInstance().getManagers()) {
