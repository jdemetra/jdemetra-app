...
@ServiceProvider(service = WorkspaceItemManager.class,
        position = 500)
public class StlPlusDocumentManager extends AbstractWorkspaceTsItemManager<StlSpec, StlPlusDocument> {


    public static final LinearId ID = new LinearId(StlSpec.FAMILY, "documents", StlSpec.METHOD);
