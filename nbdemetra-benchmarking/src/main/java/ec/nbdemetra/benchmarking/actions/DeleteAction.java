...
@ActionID(category = "Edit",
        id = "ec.nbdemetra.benchmarking.actions.DeleteAction")
@ActionRegistration(
...
@ActionReferences({
    ...
    @ActionReference(path = MultiCholetteDocumentManager.ITEMPATH, position = 1100),
    @ActionReference(path = CalendarizationDocumentManager.ITEMPATH, position = 1100)
})
