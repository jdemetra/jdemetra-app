...
public class ChainedGregorianCalendarPanel extends JPanel implements ExplorerManager.Provider, IDialogDescriptorProvider {
    ...
    static class ChainedCalendarNode extends AbstractNode {
        ...
        protected Sheet createSheet() {
            ...
            List<String> tmp = new ArrayList<>(Arrays.asList(ModellingContext.getActiveContext().getCalendars().getNames()));
    ...
    private enum ChainedConstraints implements Constraint<ChainedConstraintData> {
