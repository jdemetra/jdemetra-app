...
//        TsCollection info = new TsCollectionInformation(TsConverter.fromTsCollection(col), TsInformationType.Data);
...
//        private static final Converter<ObsFormat> DATAFORMAT = new ObsFormatParam(ObsFormat.DEFAULT, "locale", "datePattern", "numberPattern");
//        private static final Property<RegularFrequency> FREQUENCY = Property.of("frequency", RegularFrequency.Undefined, Parser.onEnum(RegularFrequency.class), Formatter.onEnum());
//        private static final Property<AggregationType> AGGREGATION_TYPE = Property.of("aggregationType", AggregationType.None, Parser.onEnum(AggregationType.class), Formatter.onEnum());
